...
This code was written to identify neurons in hilus region of hippocampus
...
if os.path.exists('hilus_masks'):
    shutil.rmtree('hilus_masks')
os.makedirs('hilus_masks')
...
for prep_date in next(os.walk('G:/HiWi/itbs/data'))[1]:
    ...
    os.makedirs('hilus_masks/'+prep_date)
    ...
    for time in next(os.walk(current_dir))[1]:
        ...
        os.makedirs('hilus_masks/'+prep_date+'/'+time)
        ...
        for file in os.listdir(foldername):
            ...
            filename.endswith('hilus')) and not (filename.endswith('dg')):
                ...
                try:
                    ...
                    raw_hilus = io.imread(foldername + '/' + filename[:-4] + '_hilus.tif')
                except OSError:
                ...
                channel0 = raw_hilus[:, 0, :, :]
                channel1 = raw_hilus[:, 1, :, :]
                ...
                save_dir = 'hilus_masks/'+prep_date+'/'+time + '/'
                print(save_dir)
